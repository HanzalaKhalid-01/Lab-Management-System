...
namespace Lab_Management_System.Controllers
{
    public class TestsController : Controller
    {
        ...
        public TestsController(LabManagementDbContext context)
        {
            _context = context;
        }
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("TestId,TestName,DefaultPrice,Description,IsActive,CreatedAt")] Test test)
        {
            if (id != test.TestId)
            {
                return NotFound();
